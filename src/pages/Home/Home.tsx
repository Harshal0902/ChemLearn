...
import HomeImg from "../../assets/Education-lumapps.png"
                ...
                <div className="p-4 origin-bottom-right lg:mx-36 md:mx-8">
                    <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                        ...
                        <div className="pr-4 md:flex md:flex-col md:justify-center align-middle pt-24">
                            ...
                            <h2 className="self-center mb-4 text-5xl font-bold tracking-wider text-indigo-800 font-carattere md:text-4xl lg:text-7xl">Chem Learn</h2>

                            <p className="self-center text-xl tracking-wide text-justify font-sourceSerifPro">Chem Learn is an AR-based web platform where students come across and learn about various complex chemical structures. Learn with the help of interactive 3D Models and AR</p>
